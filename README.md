Author: Chirra reddy Tejeswar

GitHub Username: Tejeswar0601

Email: tejeswar06012005@gmail.com
...
🗂️ Project Structure
Rainfall_Prediction_Project/ │ ├── data/ │ └── Weather.csv │ ├── notebook/ │ └── rainfall_prediction.ipynb │ ├── model/ │ ├── Rainfall.pkl │ ├── scaler.pkl │ ├── encoder.pkl │ ├── num_imputer.pkl │ └── cat_imputer.pkl │ ├── app/ │ ├── app.py │ └── templates/ │ ├── index.html │ ├── chance.html │ └── nochance.html │ └── README.md
